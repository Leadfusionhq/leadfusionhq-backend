// components/common/FormikAddressInput.tsx
...
interface FormikAddressInputProps {
  name: string;
  label?: string;
  placeholder?: string;
  errorMessage?: string;
...
const FormikAddressInput: React.FC<FormikAddressInputProps> = ({
  name,
  label,
  ...
  const handleSelectSuggestion = (suggestion: Suggestion) => {
    formik.setFieldValue(name, suggestion.description);
    setShowDropdown(false);
    setSuggestions([]);
    ...
    <div className="w-full relative" ref={dropdownRef}>
      ...
      <div className="relative">
        ...
        <Field
          ...
          disabled={formik.isSubmitting || gettingLocation}
        ...
        />
          ...
          {showCurrentLocation && !fieldValue && !isLoading && (
            <button
              type="button"
          ...
          {fieldValue && !formik.isSubmitting && (
            <button
              type="button"
              onClick={handleClear}
              className="p-1 hover:bg-gray-100 rounded transition-colors"
      ...
      {showDropdown && suggestions.length > 0 && (
        ...
        <MapLocationPicker
          ...
          initialCoordinates={
            getNestedValue(formik.values, 'address.coordinates') || undefined
          }
        />
      )}
    </div>

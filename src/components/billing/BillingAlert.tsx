      ...
      <div className="flex">
        ...
        <div className="ml-3 flex-1">
          ...
          <div className="mt-2 text-sm text-red-700">
            <p>
              Our system indicates that your funds available are below ${balance.toFixed(2)}. Please contact your account manager{" "}
              <button
              ...
              , to make sure that your available funds are optimized so that you can continue to receive leads.
            </p>
          </div>
        </div>

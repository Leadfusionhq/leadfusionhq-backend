...
const Sidebar = () => {
  ...
  const handleTouchEnd = useCallback(() => {
    ...
    // Only close on actual swipe (distance > 50px) and ensure touchEndX was set
    if (swipeDistance > 50 && touchEndX.current > 0 && collapsed) {
  ...
  }, [collapsed, handleTouchStart, handleTouchMove, handleTouchEnd]);
  ...
  return (
    <>
      ...
      {collapsed && (
        <div
          className="lg:hidden fixed inset-0 bg-black/60 backdrop-blur-sm z-[105] transition-opacity duration-300"

      ...
      <div className="bg-gradient-to-r from-indigo-600 via-purple-600 to-indigo-700 rounded-2xl p-4 sm:p-6 mb-4 sm:mb-6 text-white shadow-lg">
        <div className="flex flex-col sm:flex-row sm:items-start sm:justify-between gap-4">
          ...
          <button
            ...
            className="flex items-center justify-center gap-2 px-4 py-2.5 bg-white/20 hover:bg-white/30 rounded-xl font-medium text-sm transition-colors w-full sm:w-auto"
          >
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-4 sm:gap-6">
        ...
        {campaign.delivery && (
          <InfoCard title="Delivery Configuration" icon={<Settings className="w-4 h-4" />}>
            <div className="space-y-0">
              {campaign.delivery.method && <DetailRow label="Method" value={typeof campaign.delivery.method === 'string' ? campaign.delivery.method.toUpperCase() : String(campaign.delivery.method)} />}
      ...
      <div className="mt-4 sm:mt-6">
        <div className="bg-gradient-to-r from-indigo-600 to-purple-700 rounded-2xl p-4 sm:p-6 text-white shadow-lg">
          ...
          <div className="grid grid-cols-3 gap-3 sm:gap-6">
            ...
            <div className="text-center">
              <p className="text-2xl sm:text-3xl font-bold uppercase">{campaign.delivery?.method || 'N/A'}</p>

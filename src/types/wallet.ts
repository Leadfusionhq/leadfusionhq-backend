...
export interface Transaction {
  ...
  type: 'ADD_FUNDS' | 'WITHDRAWAL' | 'TRANSFER' | 'REFUND' | 'MANUAL' | 'AUTO' | 'DEDUCTION' | 'TEST_DEDUCTION' | 'ADMIN_ADD_FUNDS' | 'LEAD_ASSIGNMENT' | 'PAYMENT_RECOVERY';
  amount: number;
  status: 'COMPLETED' | 'PENDING' | 'FAILED' | 'SUCCESS';
  description: string;
  paymentMethod?: 'CARD' | 'BANK_TRANSFER' | 'PAYPAL' | 'OTHER' | 'BALANCE';
